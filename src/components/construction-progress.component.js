...
import "../styles/construction-progress.styles.css"
    ...
    render() {
        return (
            <div className="container gallery-container">
                <a className="anchor" id="construction-progress"/>
